...
mock.onGet('/api/management/companies').reply(200, {
  customers: [
    {
...
mock.onGet('/api/management/companies/1').reply(200, {
  customer: {
...
mock.onGet('/api/management/companies/1/emails').reply(200, {
  emails: [
    {
      id: uuidv4(),
...
mock.onGet('/api/management/companies/1/invoices').reply(200, {
  invoices: [
    {
      id: uuidv4(),
      date: moment()
...
mock.onGet('/api/management/companies/1/logs').reply(200, {
  logs: [
    {
      id: uuidv4(),
      status: 200,
